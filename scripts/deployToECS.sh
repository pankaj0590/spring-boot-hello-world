...
aws ecs create-service --cluster FARGATE-CLUSTER --service-name spring-boot-hello-world-service --task-definition spring-boot-hello-world --desired-count 1
...
aws ecs update-service --cluster FARGATE-CLUSTER --service spring-boot-hello-world-service --task-definition spring-boot-hello-world:${revision} --desired-count 1
