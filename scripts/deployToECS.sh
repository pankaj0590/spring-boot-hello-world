...
aws ecs create-service --cluster aws-ec2-cluster --service-name spring-boot-hello-world-service --task-definition spring-boot-hello-world --desired-count 1
...
aws ecs update-service --cluster aws-ec2-cluster --service spring-boot-hello-world-service --task-definition spring-boot-hello-world:${revision} --desired-count 1
