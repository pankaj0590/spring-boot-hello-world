...
aws ecs create-cluster --cluster-name ec2
aws ecs register-task-definition --family spring-boot-hello-world --cli-input-json file://taskDefinition.json --region us-east-1
aws ecs create-service --cluster ec2 --service-name spring-boot-hello-world-service --task-definition spring-boot-hello-world --desired-count 1
...
aws ecs update-service --cluster ec2 --service spring-boot-hello-world-service --task-definition spring-boot-hello-world:${revision} --desired-count 1
